...
export const estimatorServices: EstimatorService[] = [
  ...
  },
  {
    ...
    description: "Estimate fabric furniture cleaning by seating position.",
    quantityLabel: "Seating positions",
    quantityUnit: "seats",
    quantityMin: 1,
    quantityMax: 16,
    quantityStep: 1,
    ...
    baseCharge: 0,
    variance: 0,
    quantityHint: "Count each sofa seating position that needs cleaning.",
    optionLabel: "Fabric colour",
    options: [
      { label: "Standard fabric", value: "standard", hint: "$55 per seating position", unitRate: 55 },
      { label: "White fabric", value: "white", hint: "$80 per seating position", unitRate: 80 },
    ],
    toggle: {
